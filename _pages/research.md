...
* **"Data Preferences in Firm Learning: Evidence from an Online Auction Platform" (JMP)**
  * Draft available upon request
  <details>
    ...
    <ul>
      <li> 2026: BIOMS, EMAC, TPM, Marketing Science Conference</li>
...
* **“Do Store Credit Card Discounts Pay Off?”** \[[SSRN](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=7162038)\]
  ...
  * Data access through collaborating with Wharton AI & Analytics for Business (AIAB)
  <details>
    <summary>Abstract</summary>
    Store credit card discounts are widely used to sustain usage among cardholders, yet there is little evidence on whether and how they pay off. Beyond stimulating product sales, these discounts can raise revenue through two channels unique to card-specific rewards: higher interest income and lower interchange fees. We study how discounts affect card usage and how all three channels jointly determine profitability, using a rich consumer panel with unique variation in discount levels and detailed data on payment choices, profit margins, and interest payments. Estimating the causal effect of discounts on payment choice, we find that they substantially increase card usage. Discount costs, however, outpace gains from incremental sales as discounts deepen. Profitability instead hinges on interest income from increased card usage, while interchange savings are negligible because cardholders switch primarily from cash and debit rather than from other credit cards. Overall profitability is inverted-U shaped in the discount level, with the optimal discount increasing in the share of cardholders holding other credit cards. These findings establish the financial channel as central to whether store card discounts pay off and yield practical insights for store credit card programs.
  </details>
